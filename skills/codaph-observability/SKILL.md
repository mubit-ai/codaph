...
6. If the question is about chronology, agent actions, or handoffs over time, inspect `codaph mubit activity --cwd <repo> --exclude-derived --projection compact --json`.
...
7. Use `codaph mubit activity --exclude-derived --projection compact` when you need chronological audit data instead of a semantic answer.
...
- Prefer `mubit query --rank-by freshness` for “current state”, “latest work”, and “what changed recently?” questions.
